...
function Card() {
    return (
        <div className="container px-4 py-5 mx-auto bg-white card">
        <div className="row d-flex justify-content-center" style={{"background": "#"}}>
            <div className="col-5">
        ...
        <div className="row d-flex justify-content-center border-top">
            <div className="col-5">
                <div className="row d-flex">
                    ...
                    <div className="my-auto flex-column d-flex pad-left">
                        <h6 className="mob-text">Homo Deus: A Brief<br/>History of Tomorrow</h6>
